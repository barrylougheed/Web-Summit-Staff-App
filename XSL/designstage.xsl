	    	 	...
	    	 	<ul id="talktimes">
		    		 ...
		    		 <li class="talkholder draggable" onclick="location.href='#';" style="cursor:pointer">
		    		   ...
		    		   <div class="time hidetue">
		    			   <p> <xsl:apply-templates select="//designstage/thursday/morning/time/start"/> </p>
		    		   </div>
		    		   ...
		    		   <div class="contentWrapper hidetue">
	     				   <h1><xsl:apply-templates select="//designstage/thursday/morning/talk/title"/></h1>
		     				 <p><xsl:apply-templates select="//designstage/thursday/morning/talk/description"/> </p>
		     				 <!-- code learned from http://stackoverflow.com/questions/45904/how-do-you-add-an-image -->
		     				 <img width="50px" height="50px" src='{//designstage/thursday/morning/speaker/image}'></img>
		     				 <span><xsl:apply-templates select="//designstage/thursday/morning/speaker"/> </span>
		     				  <br></br>
		     				 <span><xsl:apply-templates select="//designstage/thursday/morning/speaker/info"/> </span>
		    			</div>
		    		 ...
		    		 <li class="talkholder draggable" onclick="location.href='#';" style="cursor:pointer">
		    		   ...
		    		   <div class="time hidetue">
		    			   <p> <xsl:apply-templates select="//designstage/wenesday/afternoon/time/start"/> </p>
		    		   </div>
		    		   ...
		    		   <div class="contentWrapper hidetue">
	     				 	 <h1><xsl:apply-templates select="//designstage/wenesday/afternoon/talk/title"/></h1>
		     				 <p><xsl:apply-templates select="//designstage/wenesday/afternoon/talk/description"/> </p>
		     				 <!-- code learned from http://stackoverflow.com/questions/45904/how-do-you-add-an-image -->
		     				 <img width="50px" height="50px" src='{//designstage/wenesday/afternoon/speaker/image}'></img>
		     				 <span><xsl:apply-templates select="//designstage/wenesday/afternoon/speaker"/> </span>
		     				  <br></br>
		     				 <span><xsl:apply-templates select="//designstage/wenesday/afternoon/speaker/info"/> </span>
		    			</div>
