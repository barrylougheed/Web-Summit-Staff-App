		    		 ...
		    		 <li class="talkholder draggable" onclick="location.href='#';" style="cursor:pointer">
		    		   ...
		    		   <div class="time hidetue">
		    		    ...
		    		    <div class="time hidewed">
		    		     ...
		    		     <div class="time hidethur">
		    		      <p> <xsl:apply-templates select="//musicstage/thursday/morning/talk/time/start"/> </p>
		    		    </div>
		    		   ...
		    		   <div class="contentWrapper hidetue">
		    			...
		    			<div class="contentWrapper hidethur">
		    				 <h1><xsl:apply-templates select="//musicstage/thursday/morning/talk/details/title"/></h1>
		     				 <p><xsl:apply-templates select="//musicstage/thursday/morning/talk/details/description"/> </p>
		     				 <!-- code learned from http://stackoverflow.com/questions/45904/how-do-you-add-an-image -->
		     				 <img width="50px" height="50px" src='{//musicstage/thursday/morning/talk/speaker/image}'></img>
		     				 <span><xsl:apply-templates select="//musicstage/thursday/morning/talk/speaker"/> </span>
		     				  <br></br>
		     				 <span><xsl:apply-templates select="//musicstage/thursday/morning/talk/speaker/info"/> </span>
		    			</div>
