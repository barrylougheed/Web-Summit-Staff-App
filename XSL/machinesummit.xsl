		    		   ...
		    		   <div class="time hidetue">
		    		    ...
		    		    <div class="time hidewed">
		    		     ...
		    		     <div class="time hidethur">
		    		      <p> <xsl:apply-templates select="//machinestage/thursday/morning/time/talk[1]/start"/> </p>
		    		    </div>

		    		   <div class="contentWrapper hidetue">
	     				 <h1 class="talktitle"><xsl:apply-templates select="//machinestage/tuesday/morning/talk[1]/details/title"/></h1>
		     				 <p><xsl:apply-templates select="//machinestage/tuesday/morning/talk[1]/details/description"/> </p>
		     				 <!-- code learned from http://stackoverflow.com/questions/45904/how-do-you-add-an-image -->
		     				 <img width="50px" height="50px" src='{//machinestage/tuesday/morning/talk[1]/speaker/image}'></img>
		     				 <span><xsl:apply-templates select="//machinestage/tuesday/morning/talk[1]/details/speaker"/> </span>
		     				  <br></br>
		     				 <span><xsl:apply-templates select="//machinestage/tuesday/morning/talk[1]/details/speaker/info"/> </span>
		    			</div>

		    			<div class="contentWrapper hidewed">
			    			 <h1 class="talktitle"><xsl:apply-templates select="//machinestage/wednesday/morning/talk/details/title"/></h1>
		    			...
		    			<div class="contentWrapper hidethur">
		    				 <h1 class="talktitle"><xsl:apply-templates select="//machinestage/thursday/morning/talk/details/title"/></h1>
